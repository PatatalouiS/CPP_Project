...
mais annumlent la commande courante et re-affiche le "prompt" de l'application.
...
J'ai utilisé les smart pointers, souvent plus les shared_ptr car j'ai besoin de copier partager l'ownership d'un token vers un tableau, une pile...

Seule les feuilles de l'abre d'héritages sont instanciables, toutes les autres classes sont abstraites, avec de nombreuses méthodes virtuelles pures
...
N'hésitez pas a me contacter si vous désirez plus de précisions, ou pourtout problème d'exécution/compilation
